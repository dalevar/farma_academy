...
const CardFried = () => {
  ...
  function rumusFried(e) {
    ...
    if (e.target[2].value) {
      ...
      const resultsSatu = ((n / 150) * dmSatuObat).toFixed(3);
    ...
    const results = ((n / 150) * dm).toFixed(3);
    setResult(results);
  }
  return (
          ...
          <div className="p-7">
            ...
            <div className="mt-5">
              ...
              <span className="text-sm block">
                DM 1 Hari yang harus diberikan untuk bayi usia {umur} bulan adalah{" "}
                <span className="font-bold">{result} mg </span>
              </span>
              {resultSatuObat && (
                <span className="text-sm block">
                  DM 1x yang harus diberikan untuk bayi usia {umur} bulan adalah{" "}
                  {resultSatuObat} mg
                </span>
              )}
            </div>
