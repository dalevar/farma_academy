  ...
  return (
    <div>
      ...
      <section className="min-h-screen flex items-center container mx-auto">
        <div className="md:basis-2/3 flex flex-col md:gap-5 gap-3 px-3 lg:px-0">
          <div>
            <p className="break-words text-farma-950 font-bold md:text-5xl text-2xl leading-tight">Daftar sekarang dan jadilah apoteker
          ...
          <div className="flex md:gap-5 gap-2 pl-4">
      ...
      <section className="container mx-auto flex flex-col px-3 gap-5">
        <div>
          <p className="text-center break-words text-farma-950 md:text-4xl text-2xl font-semibold leading-tight">Ingin menghitung timbangan obat dengan mudah dan cepat? </p>
        </div>
        <div>
        ...
        <div className="flex gap-5 md:gap-16 flex-wrap justify-center">
